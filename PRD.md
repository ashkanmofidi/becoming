...
MUTE CONTROL [ADDED v3.1.1 - 2026-04-09]: Mute toggle on the timer page provides instant sound control without navigating to Settings. Mute suspends ALL sounds (ticks, chimes, ambient). Unmute restores all sounds per current settings. Ambient sound resumes on unmute if it was active.
