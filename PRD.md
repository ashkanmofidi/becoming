...
SOUND DESIGN [CHANGED v3.1.1 - 2026-04-09]: Tick sound uses sound psychology principles for focus enhancement. 396Hz Solfeggio frequency (grounding/tension release) with pure sine wave, sub-threshold volume (1.5%), 300ms natural decay mimicking a water drop in a ceramic bowl. Pitch bends 396→220Hz to feel organic. 1-second interval aligns with resting heart rate for auditory-cardiac coupling. Last 30s tick is 3% volume — present but not jarring.
